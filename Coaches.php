                ...
                <tbody>
                    <?php while ($coach = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($coach['mobile_number']); ?></td>
                            <td><?= htmlspecialchars($coach['address']); ?></td>
                            <td><?= htmlspecialchars($coach['post']); ?></td>
                            <td>
                                <?php if (!empty($coach['cv'])): ?>
                                    <a href="<?= htmlspecialchars($coach['cv']); ?>" target="_blank">View CV</a>
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if (!empty($coach['photo'])): ?>
                                    <img class="profile-img" src="<?= htmlspecialchars($coach['photo']); ?>" alt="Coach Photo">
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </td>
                            <td><?= htmlspecialchars($coach['dob']); ?></td>
                            <td>₹<?= htmlspecialchars($coach['prize_charged']); ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
        <?php else: ?>
            <p class="no-data">No coaches registered yet.</p>
        <?php endif; ?>
    </div>
