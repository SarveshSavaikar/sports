...
<body>
    ...
    <form action="process_manage_profile.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="post" name="post" value="<?php echo htmlspecialchars($user['post']); ?>" required>

        <label for="dob">Date of Birth:</label>
        <input type="date" id="dob" name="dob" value="<?php echo htmlspecialchars($user['dob']); ?>" required>

        <label for="prize_charged">Prize Charged:</label>
        <input type="text" id="prize_charged" name="prize_charged" value="<?php echo htmlspecialchars($user['prize_charged']); ?>" required>
